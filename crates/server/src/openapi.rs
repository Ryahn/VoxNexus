...
use voxnexus_protocol::{
    ...
    CreateCommunityRequest, CreateInviteRequest, CreateRoleGroupRequest, CreateRoleRequest,
    ...
    RoleListResponse, RoleResponse, SpaceListResponse, SpaceMemberListResponse, SpaceMemberResponse,

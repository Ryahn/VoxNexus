<template>
	<button class="w-56 h-10 btn transition-all duration-150 focus:ring-2 focus:ring-accent focus:outline-none hover:scale-105 hover:shadow-lg" tabindex="0" role="button" :aria-label="`View user ${profile.userName}`" @keyup.enter="$emit('click')" @keyup.space="$emit('click')">
		<div

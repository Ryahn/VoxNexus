 ...
 */
export const downloadAttachment = <ThrowOnError extends boolean = false>(options: Options<DownloadAttachmentData, ThrowOnError>): RequestResult<DownloadAttachmentResponses, DownloadAttachmentErrors, ThrowOnError> => (options.client ?? client).get<DownloadAttachmentResponses, DownloadAttachmentErrors, ThrowOnError>({ url: '/api/v1/attachments/{attachment_id}', ...options });
 ...
 */
export const uploadChannelAttachment = <ThrowOnError extends boolean = false>(options: Options<UploadChannelAttachmentData, ThrowOnError>): RequestResult<UploadChannelAttachmentResponses, UploadChannelAttachmentErrors, ThrowOnError> => (options.client ?? client).post<UploadChannelAttachmentResponses, UploadChannelAttachmentErrors, ThrowOnError>({
    bodySerializer: null,
 ...
 */
export const listAuditEvents = <ThrowOnError extends boolean = false>(options: Options<ListAuditEventsData, ThrowOnError>): RequestResult<ListAuditEventsResponses, ListAuditEventsErrors, ThrowOnError> => (options.client ?? client).get<ListAuditEventsResponses, ListAuditEventsErrors, ThrowOnError>({ url: '/api/v1/communities/{community_id}/audit-events', ...options });
 ...
 */
export const viewAsChannels = <ThrowOnError extends boolean = false>(options: Options<ViewAsChannelsData, ThrowOnError>): RequestResult<ViewAsChannelsResponses, ViewAsChannelsErrors, ThrowOnError> => (options.client ?? client).post<ViewAsChannelsResponses, ViewAsChannelsErrors, ThrowOnError>({
